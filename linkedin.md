...
- Drove a platform-wide cost program spanning BigQuery optimization and the Iceberg migration, lowering monthly spend by ~60% (from ¥1.2M to under ¥500K).
